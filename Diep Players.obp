...
require('./../exports.js').registerCmd('ondiep',        'Counts the number of players playing Diep.io.');
require('./../exports.js').registerCmd('diepplayers',   'Counts the number of players playing Diep.io.');
require('./../exports.js').registerCmd('ondiepio',      'Counts the number of players playing Diep.io.');
require('./../exports.js').registerCmd('diepioplayers', 'Counts the number of players playing Diep.io.');
